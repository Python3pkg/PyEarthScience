"""
  PyEarthScience: PyNGL unstructured data draw polygons example
  ...
  The Ngl.polygon function is used because it's faster! 
...
wks1_type = 'png'
wks1 =  Ngl.open_wks(wks1_type,'Py_unstructured_ICON_triangles',wkres)
